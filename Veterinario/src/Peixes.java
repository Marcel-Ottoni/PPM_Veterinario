...
public class Peixes extends Animal{
    ...
    public Peixes(String nome,
        ...
        this.phAgua = phAgua;
        this.litragemAnimal = litragemAnimal;
    }
    public float getPhAgua(){

        return phAgua;
    }
    public int getLitragemAnimal(){

        return litragemAnimal;
    }
    @Override
    public String nomeAtendente() {
        String caminhoArquivo = "src/nomes_peixes";
