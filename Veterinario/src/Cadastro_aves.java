...
public class Cadastro_aves{
    ...
    private JComboBox temperamento_input;
    private JLabel bico;
    private JTextField bico_input;
    private JLabel asacortada;
    private JComboBox asacortada_input;

    public Cadastro_aves() {
        jp = new JPanel();
        jp.setLayout(null);
        jp.setSize(600, 650);
        ...
        bico = new JLabel("Tipo de Bico: ");
        asacortada = new JLabel("Asa Cortada: ");
        ...
        bico_input = new JTextField();
        asacortada_input = new JComboBox(opcoes_licenca);
        ...
        bico.setSize(200, 300);
        bico.setLocation(120, 335);
        asacortada.setSize(200, 300);
        asacortada.setLocation(120, 375);
        ...
        bico_input.setSize(150, 30);
        bico_input.setLocation(200, 470);
        asacortada_input.setSize(150, 30);
        asacortada_input.setLocation(200, 510);
    ...
    public String getBico_input(){
        return bico_input.getText();
    }
    public boolean getAsacortada_input(){
        if(licencaIbama_input.getSelectedItem() == "Sim"){
            return true;
        }
        else{
