import javax.swing.*;
import java.awt.*;
public class Cadastro_reptil{
    private final String[] opcoes_saude = {"Saudavel", "Doente"};
    ...
    private JLabel pele;
    private JTextField pele_input;
    private JLabel venenoso;
    private JComboBox venenoso_input;

    public Cadastro_reptil(){
        jp = new JPanel();
        jp.setLayout(null);
        jp.setSize(600,650);
        ...
        pele = new JLabel("Tipo de Pele: ");
        venenoso = new JLabel("Venenoso: ");
        ...
        pele_input = new JTextField();
        venenoso_input = new JComboBox(opcoes_licenca);
        ...
        pele.setSize(200,300);
        pele.setLocation(120,335);
        venenoso.setSize(200,300);
        venenoso.setLocation(140,375);
        ...
        pele_input.setSize(150,30);
        pele_input.setLocation(200,470);
        venenoso_input.setSize(150,30);
        venenoso_input.setLocation(200,510);
    ...
    public String getPele_input(){
        return pele_input.getText();
    }
    public boolean getVenenoso_input(){
        if(licencaIbama_input.getSelectedItem() == "Sim"){
            return true;
        }
        else{
